...
When('He clicks on edit article button', () => {
  cy.route('GET', '/api/v1/articles/47', 'fixture:articleDetail')
    .as('articleDetail');
  cy.get('[data-cy=edit-article-47]').click();
});

Then('He edit the title, introduction and categories of the article', () => {
  cy.url().should('be', '/edit-article/47');
...
Then('He seeing in the home page the articles and the edited article', () => {
  ...
  cy.get('[data-cy=article-47-title]').contains('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua');
